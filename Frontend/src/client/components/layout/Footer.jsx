...
function Footer() {
    return (
        <div className="bg-gray-100 w-full h-80">
            <div className="grid grid-cols-3 gap-20 w-[1280px] mx-auto py-10">
                <div>
                    <Link to="/" className="flex gap-4 items-end">
                        ...
                        <h2 className=" text-zinc-600 text-lg font-bold">شهر بازی فان پارکــ</h2>
                    </Link>
                ...
                <div className="mr-10">
                    <h2 className="text-lg font-bold leading-10 mb-5">بازی های پرطرفدار</h2>
                    <div className="flex items-center gap-3 leading-3 mb-6">
                        <span className="w-3 h-3 rounded-sm bg-orange-400/70 inline-block"></span>
                ...
                <div>
                    <h2 className="text-lg font-bold leading-10 mb-5">ارتباط با ما</h2>
                    <div className="flex items-center gap-3 leading-3 mb-6">
                        <span className="w-3 h-3 rounded-sm bg-orange-400/70 inline-block"></span>
